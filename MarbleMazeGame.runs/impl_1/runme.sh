...
HD_PWD='E:/Vivado_Projects/MarbleMazeGame/MarbleMazeGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MarbleMazeGame.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MarbleMazeGame.tcl -notrace
