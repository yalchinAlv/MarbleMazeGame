...
HD_PWD='E:/Vivado_Projects/MarbleMazeGame/MarbleMazeGame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MarbleMazeGame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MarbleMazeGame.tcl
